    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Crear Paquete</h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted">Completa el formulario para crear un nuevo paquete Pro.</p>

                    <form action="<?= base_url('packages/create') ?>" method="post">
                        <?= csrf_field() ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="free_cartons" name="free_cartons" value="<?= old('free_cartons') ?>" min="0" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="daily_points" name="daily_points" value="<?= old('daily_points') ?>" min="0" required>
