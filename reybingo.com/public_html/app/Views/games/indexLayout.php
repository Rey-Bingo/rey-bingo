            ...
            <div class="card-body p-3">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class='form-control form-bingo' name="datefilter" id="datefilter" onchange="gameslistGet();">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class='form-control form-bingo' name="roomfilter" id="roomfilter">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class='form-control form-bingo' name="statusfilter" id="statusfilter">
